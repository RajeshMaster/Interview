...
<?php use App\Http\Helpers; ?>
	...
	<article id="profile" class="DEC_flex_wrapper" data-category="profile profile_sub_1">
		<fieldset class="mt20">
			...
			{{ Form::open(array('name'=>'frmuseraddeditpro',
								'id'=>'frmuseraddeditpro',
								'class'=>'focusFields',
								'method' => 'POST',
								'url' => 'profile/addeditprocessprofile?mainmenu='.$request->mainmenu.'&time='.date('YmdHis'),
								'files'=>true)) }}
		...
		<fieldset class="mt10 mb10">
			<div class="col-xs-12 mb10 mt10">
				<div class="col-xs-12 buttondes" style="text-align: center;">
					@if($request->editflg =="edit")
						<button type="button" class="btn edit btn-warning box100 addeditprocessprofile">
							<i class="fa fa-edit" aria-hidden="true"></i> {{ trans('messages.lbl_update') }}
						</button>
						<a onclick="javascript:gotoprofilepage('1','{{ $request->mainmenu }}');" class="btn btn-danger box120 white"><i class="fa fa-times" aria-hidden="true"></i> {{trans('messages.lbl_cancel')}}
						</a>
					@endif
				</div>
			</div>

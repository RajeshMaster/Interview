...
<script type="text/javascript">
	...
	function checkradio(){
		if ($('#hidselectcus').val() != "") {
			var getcusId = $('#hidselectcus').val().slice(0,-1);
...
<div class="popupstyle popupsize">
			...
			<table id="data" class="tablealter  table-bordered table-striped mt10" width="99.95%" style="table-layout: fixed;">
				...
				<tbody id="search" class="staff">
					...
					@forelse($custDtl as $key => $value)
						...
						>
							<td align="center">
							<input  type="checkbox" id="<?php echo $value->customer_id; ?>" name="cusId" value="<?php echo $value->customer_id; ?>">
							</td>
							<td align="center">
								{{ $i + 1 }}
							</td>
   ...
   <div class="modal-footer bg-info mt10">
	  <center>
		 <button id="add" onclick="fnselectcustomer();" class="btn btn-success CMN_display_block box100">

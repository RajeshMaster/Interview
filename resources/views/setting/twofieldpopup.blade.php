...
<div class="popupstyle popupsize">
	<div class="modal-content">
		...
		<div class="pull-right mr30 designchange">
			<button type="button" name="edit" style="background-color: #bbb5b5;" id="edit" class="pull-left btn edit  mt10 mb10"  disabled="disabled" onclick="return fneditchecktwofield();">
				...
				<center>
					<div class="box100per text-center mt5 mb5" id="">
						<div class="CMN_display_block" id="add_var">
							<button type="button"
								class="btn btn-success box80 text-center btnsize" onclick="return fnaddedittwofield('{{ $request->location  }}','{{ $request->mainmenu }}','{{ $request->tablename }}','{{ 1 }}');">

...
<div class="" id="main_contents">
	...
	<fieldset class="mt10 mb10 pull-left dispviewMainMobile">
		<textarea id="element_html">〒&nbsp;{!! nl2br(e($getdetails[0]->postalNumber)) !!}&nbsp;{!! nl2br(e($getdetails[0]->prefNameJP)) !!}&nbsp;{{$getdetails[0]->shimei}}&nbsp;{{$getdetails[0]->street_address}}&nbsp;{{$getdetails[0]->buildingname}}&nbsp;{{ $getdetails[0]->txt_custnamejp}}</textarea>
		<div class="col-md-12">

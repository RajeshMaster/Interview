...
<article id="mail" class="DEC_flex_wrapper" data-category="mail mail_sub_1">
	...
	<div class="col-xs-12 pull-left mt10 mb10">
		...
		<a href="javascript:gotoeditpage('{{ $mailContentView[0]->mailId }}');" 
		...
		<div class="col-xs-12">
			...
			<div class="col-xs-9 mt10">
				...
				<div class="col-xs-8 mw clr_black mailname">
					{{ (!empty($mailContentView[0]->mailName) ? $mailContentView[0]->mailName : "Nill") }}
				</div>
			</div>
			<div class="col-xs-9 mt10">
			...
			<div class="col-xs-9 mt10">
				<div class="col-xs-4 tar">
					{{ Form::label('mailhr', trans('messages.lbl_mailtype'), array('class' => 'mailhr clr_blue')) }}
				</div>
				<div class="col-xs-8 mw clr_black">
					{{$mailContentView[0]->typeName }}
				</div>
			</div>
			<div class="col-xs-9 mt10 mb10">
				<div class="col-xs-4 tar">
					{{ Form::label('mailct', trans('messages.lbl_mailcontent'), array('class' => 'mailct clr_blue')) }}
				</div>
				<div class="col-xs-8 mw clr_black" style="word-break: break-word;">
					{!! nl2br(e($mailContentView[0]->content)) !!}
				</div>
			</div>

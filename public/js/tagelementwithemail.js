...
(function($)
{
    ...
    var TagSuggest = function(element, options)
    {
        ...
        var defaults = {
            ...
            /**
             * @cfg {String} alreadyExistText
             * <p>The text displayed when there are no suggestions.</p>
             * Defaults to 'No suggestions"
             */
            alreadyExistText: 'This emailid already exist',
            /**
             * @cfg {String} alreadyExistText
             * <p>The text displayed when there are no suggestions.</p>
             * Defaults to 'No suggestions"
             */
            notValidText: 'This is not a valid emailid',
        ...
        this.addToSelection = function(items, isSilent)
        {
            if (!cfg.maxSelection || _selection.length < cfg.maxSelection) {
                ...
                if(emailcheck === true) {
                  self._notEmailHelper(cfg.notValidText);
                } else {
                  $('.addpostjobprocess').attr("disabled", false);
                  $(".addpostjobprocess").removeClass( "button button-disablegrey addpostjobprocess" ).addClass( "button button-blue addpostjobprocess" );
                }
                if (emailcheck === false) {
                      ...
                      if(valuechanged === false) {
                        self._alreadyExistHelper(cfg.alreadyExistText);
                      }
        ...
        var self = {
            ...
            _renderSelection: function() {
                ...
                if (_selection.length == 0) {
                  $('.addpostjobprocess').attr("disabled", true);
                  $(".addpostjobprocess").removeClass( "button button-blue addpostjobprocess" ).addClass( "button button-disablegrey addpostjobprocess" );                  
                }
             ...
             * @private
             */
            _alreadyExistHelper: function(html) {
                ms.helper.html(html);
                if(!ms.helper.is(":visible")) {
                    ms.helper.fadeIn();
                }
